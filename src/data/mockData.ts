...
export const products: Product[] = [
  ...
  { id: 7, name: "Croissant", price: 1.10, image: "/croissant.jpg", categories: ["snacks"], description: "Croissant de mantequilla", recommended: true },
  ...
  { id: 18, name: "Bocadillo de Atún", price: 2.60, image: "🥪", categories: ["bocadillos"], description: "Atún con tomate natural y aceite de oliva", recommended: true },
  { id: 19, name: "Té Verde", price: 1.00, image: "🍵", categories: ["cafe", "healthy"], description: "Infusión de té verde en bolsita" },
  { id: 20, name: "Muffin de Arándanos", price: 1.40, image: "🧁", categories: ["postres"], description: "Bizcocho esponjoso con arándanos frescos", discount: 10 },
  { id: 21, name: "Bocadillo de Lomo", price: 2.90, image: "🥩", categories: ["bocadillos"], description: "Lomo de cerdo a la plancha con pimientos" },
